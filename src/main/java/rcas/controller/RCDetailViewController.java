...
public class RCDetailViewController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //Corner Weight
        if (rc.getCornerWeightFL() > 0.0) {
            txtNameCornerWeight1.setText(String.valueOf(rc.getCornerWeightFL()));
            txtNameCornerWeight1.setUserData(new Pair(100.0, 1200.0));
            txtNameCornerWeight1.setTooltip(new Tooltip("Wertebereich: Min = 100.0; Max = 1200.0"));
        }
        if (rc.getCornerWeightFR() > 0.0) {
            txtNameCornerWeight2.setText(String.valueOf(rc.getCornerWeightFR()));
            txtNameCornerWeight2.setUserData(new Pair(100.0, 1200.0));
            txtNameCornerWeight2.setTooltip(new Tooltip("Wertebereich: Min = 100.0; Max = 1200.0"));
        }
        if (rc.getCornerWeightRL() > 0.0) {
            txtNameCornerWeight3.setText(String.valueOf(rc.getCornerWeightRL()));
            txtNameCornerWeight3.setUserData(new Pair(100.0, 1200.0));
            txtNameCornerWeight3.setTooltip(new Tooltip("Wertebereich: Min = 100.0; Max = 1200.0"));
        }
        if (rc.getCornerWeightRR() > 0.0) {
            txtNameCornerWeight4.setText(String.valueOf(rc.getCornerWeightRR()));
            txtNameCornerWeight4.setUserData(new Pair(100.0, 1200.0));
            txtNameCornerWeight4.setTooltip(new Tooltip("Wertebereich: Min = 100.0; Max = 1200.0"));
        }

        //Tire Data
        if (!Objects.equals(rc.getFrontAxleTireModel().getName(), "")) {
            txtNameTireName.setText(rc.getFrontAxleTireModel().getName());
        }
        if (rc.getFrontAxleTireModel().getSlipAngleCoefficientC() > 0.0) {
            txtNameTireData1.setText(String.valueOf(rc.getFrontAxleTireModel().getSlipAngleCoefficientC()));
            txtNameTireData1.setUserData(new Pair(0.5, 3.0));
            txtNameTireData1.setTooltip(new Tooltip("Wertebereich: Min = 0.5; Max = 3.0"));
        }
        if (rc.getFrontAxleTireModel().getSlipAngleCoefficientB() > 0.0) {
            txtNameTireData2.setText(String.valueOf(rc.getFrontAxleTireModel().getSlipAngleCoefficientB()));
            txtNameTireData2.setUserData(new Pair(5.0, 30.0));
            txtNameTireData2.setTooltip(new Tooltip("Wertebereich: Min = 5.0; Max = 30.0"));
        }
        if (rc.getFrontAxleTireModel().getSlipAngleCoefficientE() > 0.0) {
            txtNameTireData3.setText(String.valueOf(rc.getFrontAxleTireModel().getSlipAngleCoefficientE()));
            txtNameTireData3.setUserData(new Pair(-3.0, 3.0));
            txtNameTireData3.setTooltip(new Tooltip("Wertebereich: Min = -3.0; Max = 3.0"));
        }
        if (rc.getFrontAxleTireModel().getLoadCoefficientKA() > 0.0) {
            txtNameTireData4.setText(String.valueOf(rc.getFrontAxleTireModel().getLoadCoefficientKA()));
            txtNameTireData4.setUserData(new Pair(1.0, 5.0));
            txtNameTireData4.setTooltip(new Tooltip("Wertebereich: Min = 1.0; Max = 5.0"));
        }
        if (rc.getFrontAxleTireModel().getLoadCoefficientKB() > 0.0) {
            txtNameTireData5.setText(String.valueOf(rc.getFrontAxleTireModel().getLoadCoefficientKB()));
            txtNameTireData5.setUserData(new Pair(0.000010, 0.000090));
            txtNameTireData5.setTooltip(new Tooltip("Wertebereich: Min = 0.000010; Max = 0.000090"));
        }

        if (!Objects.equals(rc.getRearAxleTireModel().getName(), "")) {
            txtNameRearTireName.setText(rc.getRearAxleTireModel().getName());
        }
        if (rc.getRearAxleTireModel().getSlipAngleCoefficientC() > 0.0) {
            txtNameRearTireData1.setText(String.valueOf(rc.getRearAxleTireModel().getSlipAngleCoefficientC()));
            txtNameRearTireData1.setUserData(new Pair(0.5, 3.0));
            txtNameRearTireData1.setTooltip(new Tooltip("Wertebereich: Min = 100.0; Max = 1200.0"));
        }
        if (rc.getRearAxleTireModel().getSlipAngleCoefficientB() > 0.0) {
            txtNameRearTireData2.setText(String.valueOf(rc.getRearAxleTireModel().getSlipAngleCoefficientB()));
            txtNameRearTireData2.setUserData(new Pair(5.0, 30.0));
            txtNameRearTireData2.setTooltip(new Tooltip("Wertebereich: Min = 5.0; Max = 30.0"));
        }
        if (rc.getRearAxleTireModel().getSlipAngleCoefficientE() > 0.0) {
            txtNameRearTireData3.setText(String.valueOf(rc.getRearAxleTireModel().getSlipAngleCoefficientE()));
            txtNameRearTireData3.setUserData(new Pair(-3.0, 3.0));
            txtNameRearTireData3.setTooltip(new Tooltip("Wertebereich: Min = -3.0; Max = 3.0"));
        }
        if (rc.getRearAxleTireModel().getLoadCoefficientKA() > 0.0) {
            txtNameRearTireData4.setText(String.valueOf(rc.getRearAxleTireModel().getLoadCoefficientKA()));
            txtNameRearTireData4.setUserData(new Pair(1.0, 5.0));
            txtNameRearTireData4.setTooltip(new Tooltip("Wertebereich: Min = 1.0; Max = 5.0"));
        }
        if (rc.getRearAxleTireModel().getLoadCoefficientKB() > 0.0) {
            txtNameRearTireData5.setText(String.valueOf(rc.getRearAxleTireModel().getLoadCoefficientKB()));
            txtNameRearTireData5.setUserData(new Pair(0.000010, 0.000090));
            txtNameRearTireData5.setTooltip(new Tooltip("Wertebereich: Min = 0.000010; Max = 0.000090"));
        }
    }
    ...
    public void btnUndoonClick(ActionEvent actionEvent) {
        ...
        for (RC car : carlist) {
            if (car.getName().equals(rc.getName())) {
                ...
                //Corner Weight
                if (rc.getCornerWeightFL() > 0.0) {
                    txtNameCornerWeight1.setText(String.valueOf(car.getCornerWeightFL()));
                }
                if (rc.getCornerWeightFR() > 0.0) {
                    txtNameCornerWeight2.setText(String.valueOf(car.getCornerWeightFR()));
                }
                if (rc.getCornerWeightRL() > 0.0) {
                    txtNameCornerWeight3.setText(String.valueOf(car.getCornerWeightRL()));
                }
                if (rc.getCornerWeightRR() > 0.0) {
                    txtNameCornerWeight4.setText(String.valueOf(car.getCornerWeightRR()));
                }

                //Tire Data
                if (!Objects.equals(car.getFrontAxleTireModel().getName(), "")) {
                    txtNameTireName.setText(car.getFrontAxleTireModel().getName());
                }
                if (rc.getFrontAxleTireModel().getSlipAngleCoefficientC() > 0.0) {
                    txtNameTireData1.setText(String.valueOf(car.getFrontAxleTireModel().getSlipAngleCoefficientC()));
                }
                if (rc.getFrontAxleTireModel().getSlipAngleCoefficientB() > 0.0) {
                    txtNameTireData2.setText(String.valueOf(car.getFrontAxleTireModel().getSlipAngleCoefficientB()));
                }
                if (rc.getFrontAxleTireModel().getSlipAngleCoefficientE() > 0.0) {
                    txtNameTireData3.setText(String.valueOf(car.getFrontAxleTireModel().getSlipAngleCoefficientE()));
                }
                if (rc.getFrontAxleTireModel().getLoadCoefficientKA() > 0.0) {
                    txtNameTireData4.setText(String.valueOf(car.getFrontAxleTireModel().getLoadCoefficientKA()));
                }
                if (rc.getFrontAxleTireModel().getLoadCoefficientKB() > 0.0) {
                    txtNameTireData5.setText(String.valueOf(car.getFrontAxleTireModel().getLoadCoefficientKB()));
                }

                if (!Objects.equals(car.getRearAxleTireModel().getName(), "")) {
                    txtNameRearTireName.setText(car.getRearAxleTireModel().getName());
                }
                if (rc.getRearAxleTireModel().getSlipAngleCoefficientC() > 0.0) {
                    txtNameRearTireData1.setText(String.valueOf(car.getRearAxleTireModel().getSlipAngleCoefficientC()));
                }
                if (rc.getRearAxleTireModel().getSlipAngleCoefficientB() > 0.0) {
                    txtNameRearTireData2.setText(String.valueOf(car.getRearAxleTireModel().getSlipAngleCoefficientB()));
                }
                if (rc.getRearAxleTireModel().getSlipAngleCoefficientE() > 0.0) {
                    txtNameRearTireData3.setText(String.valueOf(car.getRearAxleTireModel().getSlipAngleCoefficientE()));
                }
                if (rc.getRearAxleTireModel().getLoadCoefficientKA() > 0.0) {
                    txtNameRearTireData4.setText(String.valueOf(car.getRearAxleTireModel().getLoadCoefficientKA()));
                }
                if (rc.getRearAxleTireModel().getLoadCoefficientKB() > 0.0) {
                    txtNameRearTireData5.setText(String.valueOf(car.getRearAxleTireModel().getLoadCoefficientKB()));
                }
                break;
            }
        }
